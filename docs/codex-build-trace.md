...
- Public-safe app trace data exists at `data/app_traces_public.jsonl` and is mirrored to https://huggingface.co/datasets/build-small-hackathon/exam-panic-rescue-build-trace for Sharing is Caring evidence.
